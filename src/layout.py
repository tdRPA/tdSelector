...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeFilter = QTreeWidget(self.splitter_3)
        __qtreewidgetitem1 = QTreeWidgetItem()
        __qtreewidgetitem1.setText(2, u"3");
        __qtreewidgetitem1.setText(1, u"2");
        __qtreewidgetitem1.setText(0, u"1");
        self.treeFilter.setHeaderItem(__qtreewidgetitem1)
        self.treeFilter.setObjectName(u"treeFilter")
        sizePolicy4 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy4.setHorizontalStretch(1)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.treeFilter.sizePolicy().hasHeightForWidth())
        self.treeFilter.setSizePolicy(sizePolicy4)
        self.treeFilter.setEditTriggers(QAbstractItemView.DoubleClicked|QAbstractItemView.EditKeyPressed|QAbstractItemView.SelectedClicked)
        self.treeFilter.setSelectionBehavior(QAbstractItemView.SelectItems)
        self.treeFilter.setIndentation(10)
        self.treeFilter.setColumnCount(3)
        self.splitter_3.addWidget(self.treeFilter)
        self.treeFilter.header().setVisible(False)
